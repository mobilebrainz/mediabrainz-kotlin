...
data class ArtistResponse(
    ...
    @Json(name = "area") val area: AreaResponse = AreaResponse(),
    @Json(name = "begin-area") val beginArea: AreaResponse = AreaResponse(),
    @Json(name = "end-area") val endArea: AreaResponse = AreaResponse(),
    @Json(name = "life-span") val lifeSpan: LifeSpanK = LifeSpanK(),
